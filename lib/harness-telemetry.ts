...
export const harnessNodes: HarnessNode[] = [
  ...
  },
  {
    ...
    recovery: "If Graphify is stale or unavailable, say so and fall back to pinned code citations instead of pretending the graph was used.",
  },
  {
    id: "adapter",
  ...
  },
  {
    ...
    tools: ["SDD", "ADR", "architecture checklist", "Graphify"],
...
export const scenarios: Scenario[] = [
  {
    ...
    reasons: {
      graphify: "Skipped because this run changes harness docs/model/UI copy, not code architecture claims. If code-path claims appear, Graphify reopens.",
  ...
  },
  {
    ...
    events: [
      ...
      { at: "15:05", type: "node.skipped", nodeId: "graphify", message: "Graphify skipped: no code or architecture claim in scope.", status: "skipped" },
