...
2. Run the always-required goal, context, skill-registry, and proof gates, plus classification, foundation, code-intelligence, production, AI-assurance, eval, trajectory, smoke, and domain-pack gates when the adapter and route make them applicable. Verify every non-applicability decision rather than assuming every possible gate is unconditional.
